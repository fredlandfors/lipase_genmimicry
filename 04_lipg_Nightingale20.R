...
# LIPG rs77960347 [N396S] decreases LIPG activity, harmonize betas according to alternative allele effect
...
ggsave(plot = EL_angptl8_plot,
       path = paste0(wd, "/plots/04_lipg_Nightingale20"),
       filename = "lipg_a8_Nightingale20.pdf",
