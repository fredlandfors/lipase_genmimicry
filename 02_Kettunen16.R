...
# Get data ----
cbind_df <- data.table::fread(file = paste0(wd, "/data/2_Kettunen20.txt"))
...
ggsave(plot = angptl4_plot,
       path = paste0(wd, "/plots/02_Kettunen16"),
       filename = "angptl4_Kettunen16.pdf",
       width = scatter.width, height = scatter.height, units = "in", dpi = 1100)
ggsave(plot = angptl3_plot,
       path = paste0(wd, "/plots/02_Kettunen16"),
       filename = "angptl3_Kettunen16.pdf",
       width = scatter.width, height = scatter.height, units = "in", dpi = 1100)
ggsave(plot = angptl8_plot,
       path = paste0(wd, "/plots/02_Kettunen16"),
       filename = "angptl8_Kettunen16.pdf",
       width = scatter.width, height = scatter.height, units = "in", dpi = 1100)
...
ggsave(plot = av_plot_a3_a8,
       path = paste0(wd, "/plots/02_Kettunen16"),
       filename = "avplot1_Kettunen16.pdf",
...
### -45 degrees rotation ----
pdf(
  file = paste0(wd, "/plots/3dscatters/angptl3-angptl8_Kettunen16_rot45dgr.pdf"),
  width =  threed.width, 
...
### -13 degrees rotation ----
pdf(
  file = paste0(wd, "/plots/3dscatters/angptl3-angptl8_Kettunen16_rot13dgr.pdf"),
  width =  threed.width, 
  height = threed.height
) 
threed_plot(x = cbind_df$beta.tg.ANGPTL3, 
...
### +32 degrees rotation ----
pdf(
  file = paste0(wd, "/plots/3dscatters/angptl3-angptl8_Kettunen16_rot32dgr.pdf"),
  width =  threed.width, 
  height = threed.height
) 
threed_plot(x = cbind_df$beta.tg.ANGPTL3, 
...
pdf(
  file = paste0(wd, "/plots/Kettunen16/main_angptl3-angptl8_Kettunen16_rot155dgr.pdf"),
  width =  threed.width, 
  height = threed.height
) 
threed_plot(x = cbind_df$beta.tg.ANGPTL3, 
